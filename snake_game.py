...
background_color = pygame.Color(0, 49, 83)  # we will fill background color as black
...
class snake:
    ...
    def draw(self, screen):
        pygame.draw.rect(screen, pygame.color.Color(255, 112, 94), (self.stack[0].x, self.stack[0].y,
        ...
        while (counter < len(self.stack)):
            if (self.stack[counter].color == "NULL"):
                counter += 1
                continue
            pygame.draw.rect(screen, pygame.color.Color(155, 203, 235), (self.stack[counter].x,
...
def drawScore(score):
    score_numb = score_numb_font.render(str(score ), 1, pygame.Color(223, 255, 0))
